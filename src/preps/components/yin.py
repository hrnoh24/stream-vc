...
def estimate(
    ...
    # TODO: the cumulative mean normalized difference value at the estimated period 
    cmdf_voiced = np.zeros_like(pitch)
    
    # TODO: the cumulative mean normalized difference value at the estimated unvoiced
    cmdf_unvoiced = np.zeros_like(pitch)
    
    return pitch, cmdf_voiced, cmdf_unvoiced
